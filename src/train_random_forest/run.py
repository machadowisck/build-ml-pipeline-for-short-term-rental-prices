...
def go(args):
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="output artifact for the pipeline",
        metadata=rf_config
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # 1 - A y to impute missing values
    # 2 - A OneHotEncoder() step to encode the variable
    # non_ordinal_categorical_preproc = make_pipeline(StandardScaler(), GaussianNB(priors=None))
